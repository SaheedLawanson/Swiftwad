...
export default class SwiftwadCognitoConstruct extends Construct {
  constructor(scope, id, extension) {
    ...
    this.userPool = new cognito.UserPool(this, `SwiftwadUserPool-${extension}`, {
      userPoolName: `SwiftwadUserPool-${extension}`,
    ...
    this.userPoolClient = this.userPool.addClient(`SwiftwadUPClient-${extension}`, {
      userPoolClientName: `SwiftwadUPClient-${extension}`,
      authFlows: {
        userPassword: true,
        userSrp: true,
